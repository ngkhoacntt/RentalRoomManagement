...
public abstract class BaseActivity extends AppCompatActivity {
    ...
    protected void setInDebugMode(boolean isDebug) {
    ...
    public void startActivity(Class<?> cls, Bundle bundle) {
        startActivity(cls, bundle, IUITransactionType.ANIM_RIGHT_TO_LEFT);
    }
    ...
    public void finish() {
        ...
        overridePendingTransition(
                IUITransactionType.ANIM_LEFT_TO_RIGHT[0], IUITransactionType.ANIM_LEFT_TO_RIGHT[1]);
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            consumed = onResultOk(requestCode, data);
        } else {
            consumed = onResultCancel(requestCode, data);
        }
    ...
    protected boolean onResultOk(int requestCode, Intent data) {
        return false;
    }

    protected boolean onResultCancel(int requestCode, Intent data) {
        return false;
    }
